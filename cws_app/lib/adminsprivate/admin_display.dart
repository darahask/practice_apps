...
import 'package:cws_app/adminsprivate/admin_chat.dart';
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: <Widget>[
            MessagesStream('Design Admin'),
            MessagesStream('Development Admin'),
            MessagesStream('Client Support'),
          ],
        ),
      ),
    );
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => AdminPrivateChat(
